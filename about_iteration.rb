...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Similar to JavaScript's reduce. Arguments supplied to inject method
    # is the starting value and the reducer that is applied to the 
  ...
  # 
  # So that we don't need to assign it to a variable?
