...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # Some classes from the standard library have their own send implementation,
    # thus, making __send__ safer to use.
    # Reference: https://stackoverflow.com/questions/4658269/ruby-send-vs-send#answer-4658359
  end
