...
class AboutClassMethods < Neo::Koan
  ...
  # I personally prefer self.method but after reading the following article
  # it seems that class << self is the more mature way of doing it.
  # Reference: https://railsware.com/blog/better-ruby-choosing-convention-for-class-methods-definition/
