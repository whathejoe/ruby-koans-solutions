...
class AboutRegularExpressions < Neo::Koan
  ...
  #
  # Why?
  # Because it'll try to match as many occurences as possible before stopping.
  ...
  # Character classes matches one character out of a set while alternation allows matching of varying lengths.
  ...
  def test_sub_is_like_find_and_replace
    assert_equal "one t-three", "one two-three".sub(/(t\w*)/) { puts $1[0, 1]; return $1[0, 1] }
  end
